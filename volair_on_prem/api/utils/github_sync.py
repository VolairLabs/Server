...
class github_:
    def __init__(self, token, repo_owner, repo_name):
        ...
        self.author_name = "getvolair"
        self.author_email = "info@volair.co"
...
github = github_(
    os.environ.get("github_token", False),
    os.environ.get("github_repo_owner", False),
    os.environ.get("github_repo_name", False),
)
