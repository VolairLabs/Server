...
if not kot_db_.get("default_model"):
    kot_db_.set("default_model", os.environ.get("default_model", "volair_local_model"))

if not kot_db_.get("default_search_model"):
    kot_db_.set("default_search_model", os.environ.get("default_search_model", "nomic-embed-text-volair"))
...
if not kot_db_.get("openai"):
    kot_db_.set("openai", os.environ.get("openai", "false").lower() == "true")
